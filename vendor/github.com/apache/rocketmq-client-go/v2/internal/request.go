...
const (
	...
	ReqUpdateAndCreateAclConfig      = int16(50)
	ReqDeleteAclConfig               = int16(51)
	ReqUpdateGlobalWhiteAddrsConfig  = int16(53)
	ReqGetBrokerClusterAclInfo       = int16(52)
	...
	ReqGetKVListByNamespace          = int16(219)
...
type UpdateGlobalWhiteAddrsConfigRequestHeader []string

func (request UpdateGlobalWhiteAddrsConfigRequestHeader) Encode() map[string]string {
	maps := make(map[string]string)
	maps["globalWhiteAddrs"] = strings.Join(request, ",")
	return maps
}
